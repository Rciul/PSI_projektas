...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Operation.date'
        db.add_column(u'stock_info_operation', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Operation.date'
        db.delete_column(u'stock_info_operation', 'date')
