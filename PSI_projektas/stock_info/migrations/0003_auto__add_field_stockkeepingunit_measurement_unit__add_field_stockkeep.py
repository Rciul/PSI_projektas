...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockKeepingUnit.measurement_unit'
        db.add_column(u'stock_info_stockkeepingunit', 'measurement_unit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True),
                      keep_default=False)

        # Adding field 'StockKeepingUnit.base_units'
        db.add_column(u'stock_info_stockkeepingunit', 'base_units',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockKeepingUnit.measurement_unit'
        db.delete_column(u'stock_info_stockkeepingunit', 'measurement_unit')

        # Deleting field 'StockKeepingUnit.base_units'
        db.delete_column(u'stock_info_stockkeepingunit', 'base_units')
